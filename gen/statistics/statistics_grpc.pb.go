...
func (c *statisticsServiceClient) GetStatistics(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetStatisticsResponse, error) {
...
func (UnimplementedStatisticsServiceServer) GetStatistics(context.Context, *Empty) (*GetStatisticsResponse, error) {
...
func _StatisticsService_GetStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatisticsServiceServer).GetStatistics(ctx, req.(*Empty))
	}
